...
export default function TaskDetailsModal({
  ...
  // Clean description (remove any priority markers)
  const cleanDescription = task.description
    ? task.description.replace(/\[Priority: (high|medium|low)\]/i, "").trim()
    : "";
        ...
        <div className="py-4 space-y-4">
          {cleanDescription && (
            <div className="space-y-1">
              ...
              <p className="text-slate-200 break-words">{cleanDescription}</p>
            </div>
          )}
